        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="px-8 md:px-16 lg:px-24 relative overflow-hidden">
              ...
              <span id="about" className="relative block -top-32 md:-top-48 invisible h-0 w-0"></span>
              <div
              ...
              <span id="schedule" className="relative block -top-32 md:-top-48 invisible h-0 w-0"></span>
              <div
                className="mt-24 md:mt-32 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center max-w-6xl mx-auto"
              >
                ...
                <div className="space-y-6 text-left order-1 lg:order-2">
                  ...
                  <div className="text-base md:text-lg text-white/80 max-w-md text-left space-y-4 leading-relaxed">
                    <p>
                      On each day, the competition runs after school from <span className="text-white font-medium">3:00 PM to 5:30 PM</span>.
                    </p>
              ...
              <span id="venue" className="relative block -top-32 md:-top-48 invisible h-0 w-0"></span>
              <div
                className="mt-24 md:mt-32 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center max-w-6xl mx-auto"
              >
                <div className="space-y-6 text-left">
            ...
            <span id="faq" className="relative block -top-32 md:-top-48 invisible h-0 w-0"></span>
            <div>
              <FAQ />
            </div>
